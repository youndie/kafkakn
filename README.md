...
| **Consumer groups, rebalancing, commits** | planned — [B-37](docs/backlog/B-37-consumer-groups.md). A consumer that assigns partitions, seeks and polls is in since [B-36](docs/backlog/B-36-assign-and-poll.md), built to a contract designed first ([B-35](docs/backlog/B-35-the-consumer-designed-first.md)); group coordination is where most of a Kafka client's difficulty lives |
