...
**State (2026-09-26): stages 0 to 15 are closed; stage 16 (B-73, B-74: what a cancelled `send` means) is open. `kafkakn-soak` ran an hour under chaos, exactly once, with no memory growth.** The producer has parity with the clients
