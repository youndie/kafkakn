...
class ProduceTest {
    ...
    @Test
    fun a_record_with_no_key_reaches_the_topic() = runTest {
    ...
    @Test
    fun records_with_the_same_key_land_on_one_partition() = runTest {
    ...
    @Test
    fun a_topic_that_does_not_exist_is_an_error_not_a_silence() = runTest {
        val producer = kafkaProducer(producerConfig())
    ...
    @Test
    fun acks_reaches_the_broker_and_is_honoured() = runTest {
    ...
    private fun producerConfig(vararg extra: Pair<String, String>) = ProducerConfig(
        buildMap {
