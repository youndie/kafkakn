...
class HeadersTest {
    ...
    @Test
    fun headers_reach_the_broker_with_their_bytes_intact() = runTest {
    ...
    @Test
    fun a_header_with_no_value_is_not_a_header_with_an_empty_one() = runTest {
    ...
    @Test
    fun a_record_without_headers_still_produces() = runTest {
    ...
    private suspend fun send(stamp: String, headers: List<RecordHeader>): RecordMetadata {
